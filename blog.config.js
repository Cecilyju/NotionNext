...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个凡夫俗子, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '一个行走于红尘间的凡夫俗子', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://vip.cecily.eu.org', // 网站地址
